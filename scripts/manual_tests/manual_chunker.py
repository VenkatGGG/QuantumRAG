...
def main() -> int:
    ...
    model_name_for_test = "sentence-transformers/all-MiniLM-L6-v2"
    test_text = "This is a test sentence for token counting."
    chunker_count = chunker.count_tokens(test_text)
    expected_tokenizer_obj = AutoTokenizer.from_pretrained(model_name_for_test)
